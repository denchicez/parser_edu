...
def get_html(url):  # делаем запрос на html страничку
    try:
        ...
        with open('org.csv', 'w', newline="") as file:
            ...
            writer.writerow(
                ['Адрес организации', 'Номер телефона орагнизации', 'Номер дополнительного телефона орагнизации',
                 'email aдрес',
                 'Адрес сайта', 'Работает ли сайт?', 'title сайта организации', 'description сайта организации',
                 'keywords сайта организации',
                 'Cайт принадлежит организации?', 'Количество подписчиков Instagramm',
                 'Ссылки на соц. сети в Instagramm', 'Количество подписчиков VK', 'Ссылки на соц. сети в VK',
                 'Количество подписчиков youtube', 'Ссылки на соц. сети в youtube', 'id региона',
                 'Полное наименование об организации (по уставу)', 'Краткое наименование организации',
                 'Дата создания организации',
                 'Юридическое лицо / Филиал', 'Общее количество сотрудников', 'Субъект РФ', 'Тип организации',
                 'Количество занимающихся детей',
                 'Количество занимающихся детей художественной направленностью',
                 'Количество занимающихся детей естественно-научной направленностью',
                 'Количество занимающихся детей технической направленностью',
                 'Количество занимающихся детей социально-педагогической направленностью',
                 'Количество занимающихся детей физкультурно-спортивной направленностью',
                 'Количество занимающихся детей туристической направленностью',
                 'Количество занимающихся детей интеллектуально игровой направленностью', 'Фактическая наполняемость',
                 'Количество педагогов',
                 'Количество педагогов художественной направленности',
                 'Количество педагогов естественно-научной направленности',
                 'Количество педагогов технической направленности',
                 'Количество педагогов социально-педагогической направленности',
                 'Количество педагогов физкультурно-спортивной направленности',
                 'Количество педагогов туристической направленности',
                 'Количество педагогов интеллектуально игровой направленности', 'okfs', 'okopf', 'ogrn', 'inn',
                 'Номер бланка лицензии', 'Кем выдана лицензии', 'Cрок лицензии',
                 'id', 'Техническое', 'Естественнонаучная'])
            for organizat in organizationsss:
                organizat['Адрес сайта'] = organizat['Адрес сайта'].replace('\u200b', '')
                try:
                    writer.writerow([organizat['Адрес организации'], organizat['Номер телефона орагнизации'],
                                     organizat['Номер дополнительного телефона орагнизации'], organizat['email aдрес'],
                                     organizat['Адрес сайта'], organizat['Работает ли сайт?'],
                                     organizat['title сайта организации'], organizat['description сайта организации'],
                                     organizat['keywords сайта организации'],
                                     organizat['Cайт принадлежит организации?'],
                                     organizat['Количество подписчиков Instagramm'],
                                     organizat['Ссылки на соц. сети в Instagramm'],
                                     organizat['Количество подписчиков VK'], organizat['Ссылки на соц. сети в VK'],
                                     organizat['Количество подписчиков youtube'],
                                     organizat['Ссылки на соц. сети в youtube'], organizat['id региона'],
                                     organizat['Полное наименование организации (по уставу)'],
                                     organizat['Краткое наименование организации'],
                                     organizat['Дата создания организации'], organizat['Юридическое лицо / Филиал'],
                                     organizat['Общее количество сотрудников'], organizat['Субъект РФ'],
                                     organizat['Тип организации'], organizat['Количество занимающихся детей'],
                                     organizat['Количество занимающихся детей художественной направленностью'],
                                     organizat['Количество занимающихся детей естественно-научной направленностью'],
                                     organizat['Количество занимающихся детей технической направленностью'], organizat[
                                         'Количество занимающихся детей социально-педагогической направленностью'],
                                     organizat['Количество занимающихся детей физкультурно-спортивной направленностью'],
                                     organizat['Количество занимающихся детей туристической направленностью'],
                                     organizat['Количество занимающихся детей интеллектуально игровой направленностью'],
                                     organizat['Фактическая наполняемость'], organizat['Количество педагогов'],
                                     organizat['Количество педагогов художественной направленности'],
                                     organizat['Количество педагогов естественно-научной направленности'],
                                     organizat['Количество педагогов технической направленности'],
                                     organizat['Количество педагогов социально-педагогической направленности'],
                                     organizat['Количество педагогов физкультурно-спортивной направленности'],
                                     organizat['Количество педагогов туристической направленности'],
                                     organizat['Количество педагогов интеллектуально игровой направленности'],
                                     organizat['okfs'], organizat['okopf'], organizat['ogrn'], organizat['inn'],
                                     organizat['Номер бланка лицензии'], organizat['Кем выдана лицензии'],
                                     organizat['Cрок лицензии'], organizat['id'], organizat['Техническое'],
                                     organizat['Естественнонаучная']])
                except:
                    try:
                        writer.writerow([organizat['Адрес организации'], organizat['Номер телефона орагнизации'],
                                         organizat['Номер дополнительного телефона орагнизации'],
                                         organizat['email aдрес'], organizat['Адрес сайта'],
                                         organizat['Работает ли сайт?'], 'Неизвестная кодировка',
                                         'Неизвестная кодировка', 'Неизвестная кодировка',
                                         organizat['Cайт принадлежит организации?'],
                                         organizat['Количество подписчиков Instagramm'],
                                         organizat['Ссылки на соц. сети в Instagramm'],
                                         organizat['Количество подписчиков VK'], organizat['Ссылки на соц. сети в VK'],
                                         ...
                                         organizat['Количество занимающихся детей художественной направленностью'],
                                         organizat['Количество занимающихся детей естественно-научной направленностью'],
                                         organizat['Количество занимающихся детей технической направленностью'],
                                         organizat[
                                             'Количество занимающихся детей социально-педагогической направленностью'],
                                         organizat[
                                             'Количество занимающихся детей физкультурно-спортивной направленностью'],
                                         organizat['Количество занимающихся детей туристической направленностью'],
                                         organizat[
                                             'Количество занимающихся детей интеллектуально игровой направленностью'],
                                         organizat['Фактическая наполняемость'], organizat['Количество педагогов'],
                                         organizat['Количество педагогов художественной направленности'],
                                         organizat['Количество педагогов естественно-научной направленности'],
                                         organizat['Количество педагогов технической направленности'],
...
def count_predkov(string, start, html, lasting):
    last = 0
    ...
    if (tmp != -1):
        ...
        counter = 0
    last = max(last, max(start, lasting))
    return counter, last
...
def NameCheck(string, code1, code2):  # Можно ли расшифровать stirng с помощью code1 и code2
    letters = ['<', '>', '«', '»', chr(9), chr(13), chr(10), '(', ')', '|', ':', ' ', chr(34), 'a', 'b', 'c', 'd', 'e',
               'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z',
               'а', 'a', 'б', 'в', 'г', 'д', 'е', 'ё', 'ж', 'з', 'и', 'й', 'к', 'л', 'м', 'н', 'о', 'п', 'р', 'с', 'т',
    ...
    if (estestv == 1 or techno == 1):
        ...
        if (site_is_work == True):
            ...
            if (title_org_site != 'У сайта неизвестная кодировка' and title_org_site != 'Не найдено'):
                ...
                podpis_youtube, podpis_vk, podpis_inst, youtubes, vks, insts = social_links = get_social_links(
                    get_links_from_page(url_name))
                if (podpis_youtube == 0):
                    podpis_youtube = 'Нет аккаунта'
                else:
        ...
        last = 0
        all_ped, last = count_predkov("Всего:", 0, HTML, last)
        count_ped_paints, last = count_predkov("Художественная направленность:", 0, HTML, last)
        count_ped_estesv, last = count_predkov("Естественнонаучная направленность:", 0, HTML, last)
        count_ped_techno, last = count_predkov("Техническая направленность:", 0, HTML, last)
        count_ped_socium, last = count_predkov("Социально-педагогическая направленность:", 0, HTML, last)
        count_ped_fizra, last = count_predkov("Физкультурно-спортивная направленность:", 0, HTML, last)
        count_ped_turist, last = count_predkov("Туристско-краеведческая направленность:", 0, HTML, last)
        count_ped_intellect, last = count_predkov("Интеллектуальные игры направленность:", 0, HTML, last)
        # --------------Количество детей в каждом из направлений и в целом--------------#
        all_child, last = count_predkov("Всего:", last, HTML, last)
        count_child_paints, tmp = count_predkov("Художественная направленность:", last, HTML, last)
        count_child_estesv, tmp = count_predkov("Естественнонаучная направленность:", last, HTML, last)
        count_child_techno, tmp = count_predkov("Техническая направленность:", last, HTML, last)
        count_child_socium, tmp = count_predkov("Социально-педагогическая направленность:", last, HTML, last)
        count_child_fizra, tmp = count_predkov("Физкультурно-спортивная направленность:", last, HTML, last)
        count_child_turist, tmp = count_predkov("Туристско-краеведческая направленность:", last, HTML, last)
        count_child_intellect, tmp = count_predkov("Интеллектуальные игры направленность:", last, HTML, last)
...
with open('org.csv', 'w', newline="") as file:
    writer = csv.writer(file, delimiter=',')
    writer.writerow(
        ['Адрес организации', 'Номер телефона орагнизации', 'Номер дополнительного телефона орагнизации', 'email aдрес',
         'Адрес сайта', 'Работает ли сайт?', 'title сайта организации', 'description сайта организации',
         'keywords сайта организации',
         'Cайт принадлежит организации?', 'Количество подписчиков Instagramm', 'Ссылки на соц. сети в Instagramm',
         'Количество подписчиков VK', 'Ссылки на соц. сети в VK',
         'Количество подписчиков youtube', 'Ссылки на соц. сети в youtube', 'id региона',
         'Полное наименование об организации (по уставу)', 'Краткое наименование организации',
         'Дата создания организации',
         'Юридическое лицо / Филиал', 'Общее количество сотрудников', 'Субъект РФ', 'Тип организации',
    ...
    for organizat in organizationsss:
        ...
        try:
            writer.writerow([organizat['Адрес организации'], organizat['Номер телефона орагнизации'],
                             ...
                             organizat['Адрес сайта'], organizat['Работает ли сайт?'],
                             organizat['title сайта организации'], organizat['description сайта организации'],
                             organizat['keywords сайта организации'], organizat['Cайт принадлежит организации?'],
                             organizat['Количество подписчиков Instagramm'],
                             organizat['Ссылки на соц. сети в Instagramm'], organizat['Количество подписчиков VK'],
                             organizat['Ссылки на соц. сети в VK'], organizat['Количество подписчиков youtube'],
                             organizat['Ссылки на соц. сети в youtube'], organizat['id региона'],
                             organizat['Полное наименование организации (по уставу)'],
                             organizat['Краткое наименование организации'], organizat['Дата создания организации'],
                             organizat['Юридическое лицо / Филиал'], organizat['Общее количество сотрудников'],
                             organizat['Субъект РФ'], organizat['Тип организации'],
                             organizat['Количество занимающихся детей'],
                             organizat['Количество занимающихся детей художественной направленностью'],
                             organizat['Количество занимающихся детей естественно-научной направленностью'],
                             organizat['Количество занимающихся детей технической направленностью'],
                             organizat['Количество занимающихся детей социально-педагогической направленностью'],
                             organizat['Количество занимающихся детей физкультурно-спортивной направленностью'],
                             organizat['Количество занимающихся детей туристической направленностью'],
                             organizat['Количество занимающихся детей интеллектуально игровой направленностью'],
                             organizat['Фактическая наполняемость'], organizat['Количество педагогов'],
            ...
            try:
                writer.writerow([organizat['Адрес организации'], organizat['Номер телефона орагнизации'],
                                 organizat['Номер дополнительного телефона орагнизации'], organizat['email aдрес'],
                                 organizat['Адрес сайта'], organizat['Работает ли сайт?'], 'Неизвестная кодировка',
                                 'Неизвестная кодировка', 'Неизвестная кодировка',
                                 organizat['Cайт принадлежит организации?'],
                                 organizat['Количество подписчиков Instagramm'],
                                 organizat['Ссылки на соц. сети в Instagramm'], organizat['Количество подписчиков VK'],
